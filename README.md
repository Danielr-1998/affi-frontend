...
[Click here to finish setting up your workspace!](https://cloud.nx.app/connect/38tE9UCkRt)
...
```sh
npx nx serve affi-platform
```

To create a production bundle:

```sh
npx nx build affi-platform
```

To see all available targets to run for a project, run:

```sh
npx nx show project affi-platform
```
